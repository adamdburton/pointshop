...
function PANEL:Submit()
	local other
	for _, ply in pairs(player.GetAll()) do if ( tonumber( ply:UniqueID() ) == tonumber( self.selected_uid ) ) then other = ply end end
...
function PANEL:Update()
	...
	if ( !self.selected_uid ) then disabled = true end
