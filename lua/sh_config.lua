...
PS.Config.ExceptedItems = { --What can be bought when alive or dead. Do not add hats or playermodels.
--"example1", --Use name of item file, i.e. example1.lua is example1. Passive Items only
--"example2"
}
